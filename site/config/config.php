...
$selectableBrandColors = [
    "cardiomon-dark-green" => [
        "label" => "CarDioMon Dark Green",
        "light-tailwindcss-bg-class" => "bg-lime-900",
        "light-tailwindcss-border-class" => "border-lime-900",
        "light-tailwindcss-text-class" => "text-lime-900",
        "light-contrast-tailwindcss-prose-class" => "prose-white",
        "light-contrast-tailwindcss-text-class" => "text-white",
        "dark-tailwindcss-bg-class" => "dark:bg-lime-500",
        "dark-tailwindcss-border-class" => "dark:border-lime-500",
        "dark-tailwindcss-text-class" => "dark:text-lime-500",
        "dark-contrast-tailwindcss-prose-class" => "dark:prose-black",
        "dark-contrast-tailwindcss-text-class" => "dark:text-black",
    ],
    "cardiomon-light-green" => [
        "label" => "CarDioMon Light Green",
        "light-tailwindcss-bg-class" => "bg-lime-300",
        "light-tailwindcss-border-class" => "border-lime-300",
        "light-tailwindcss-text-class" => "text-lime-300",
        "light-contrast-tailwindcss-prose-class" => "prose-black",
        "light-contrast-tailwindcss-text-class" => "text-black",
        "dark-tailwindcss-bg-class" => "dark:bg-lime-700",
        "dark-tailwindcss-border-class" => "dark:border-lime-700",
        "dark-tailwindcss-text-class" => "dark:text-lime-700",
